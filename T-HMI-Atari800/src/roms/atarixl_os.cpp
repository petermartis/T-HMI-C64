...
// Using ASCII character codes since our font is ASCII-based:
// Space=0x20, A-Z=0x41-0x5A, 0-9=0x30-0x39, -=0x2D
static const uint8_t screen_text[] = {
    // Line 1: "   ATARI 800XL EMULATOR   " (40 chars, centered)
    ...
    0x58, 0x4C, // XL
    0x20, // space
    0x45, 0x4D, 0x55, 0x4C, 0x41, 0x54, 0x4F, 0x52, // EMULATOR
    0x20, 0x20, 0x20, 0x20, 0x20, 0x20, // 6 spaces to fill 40 chars
    // Line 2: "      FOR LILYGO T-HMI      " (40 chars, centered)
    0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, // 9 spaces
    0x46, 0x4F, 0x52, // FOR
    0x20, // space
    0x4C, 0x49, 0x4C, 0x59, 0x47, 0x4F, // LILYGO
    0x20, // space
    0x54, 0x2D, 0x48, 0x4D, 0x49, // T-HMI
    0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, // 11 spaces to fill 40 chars
};
...
const uint8_t* getCharacterRom(size_t* size) {
    if (size) *size = sizeof(atari_charset);
    return atari_charset;
}
